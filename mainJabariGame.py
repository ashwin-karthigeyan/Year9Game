...
#playsound.playsound('Terraria Music - Ocean.mp3',block=False)
mixer.music.load('Terraria Music - Ocean.mp3')
mixer.music.play('Terraria Music - Ocean.mp3') #Playing Music with Pygame
time.sleep(28)
mixer.music.stop()
#Loading Music File
...
if answer1 == 'continue':
    print ('you begin to walk towards the diving board')
if answer1 == 'give up': 
    Loserxd()
